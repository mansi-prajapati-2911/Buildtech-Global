...
<?php } else { ?>
	...
	<div class="meta">
		<h5 class="psg-sp-comment-athor-name woocommerce-review__author"><?php comment_author(); ?> </h5>
		<p class="psg-sp-comment-date">(<?php echo esc_html( get_comment_date( wc_date_format() ) ); ?>)</p>
		<?php
