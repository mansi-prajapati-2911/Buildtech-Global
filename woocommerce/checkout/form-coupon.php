...
<form class="checkout_coupon woocommerce-form-coupon" method="post">
	<p class="psg-checkout-coupon-code-field form-row">
		<input type="text" name="coupon_code" class="input-text" placeholder="<?php esc_attr_e( 'Apply coupon code', 'woocommerce' ); ?>" id="coupon_code" value="" />
