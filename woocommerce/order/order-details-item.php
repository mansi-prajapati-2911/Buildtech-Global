...
<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order ) ); ?>">
	...
	<td class="woocommerce-table__product-thumbnail product-thumbnail" data-title="Product">
	
        <span class="view-order-image-small"><?php echo get_the_post_thumbnail( $item['product_id'], 'thumbnail' ); ?></span>
		
		<div class="psg-view-order-table-pd">
			<?php
	...
	<td class="woocommerce-table__product-price product-price" data-title="Price">		
		<?php //echo get_woocommerce_currency_symbol() .  $product->get_price(); ?>
		<?php echo $product->get_price_html(); ?>
	</td> 
	
	
	<td class="woocommerce-table__product-name product-quantity" data-title="Quantity">
	<?php
