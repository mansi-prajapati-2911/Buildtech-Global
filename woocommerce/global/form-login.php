...
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo ( $hidden ) ? 'style="display:none;"' : ''; ?>>
	...
	<p class="form-row form-row-first">
		...
		<input type="text" class="input-text" name="username" id="username" placeholder="Enter Username or Email Address" autocomplete="username" />
	</p>
	<p class="form-row form-row-last">
		<label for="password"><?php esc_html_e( 'Password', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
		<input class="input-text" type="password" name="password" id="password" placeholder="Enter Password" autocomplete="current-password" />
	</p>
	<div class="clear"></div>
